    ...
    <div class="container">
        <div class="navbar navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
                    <div class="brand" style="float:left"><?php echo $galleria; ?></div>
                    <div class="brand" style="float: right"><a href="http://www.olbc.it" style="color: white">HOME</a></div>
                </div>
            </div>
        </div>
                ...
                <ul>
                    <?php foreach ($galleryArray['paginator'] as $item): ?>
                        ...
                        <li class="<?php echo $class; ?>">
                            <a href="<?php echo empty($item['href']) ? '#' : $item['href'] . '&' . $galleria; ?>"><?php echo $item['text']; ?></a>
                        </li>
